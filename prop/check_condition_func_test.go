...
func TestCheckCondition(t *testing.T) {
	call, err := checkConditionFuncT(0, 0)
	if err == nil || call != nil {
		t.Error("Should not work for integers")
	}

	call, err = checkConditionFuncT(func(a, b int) bool {
		return false
	}, 1)
	if err == nil || call != nil {
	...
	call, err = checkConditionFuncT(func(a, b int) {
	}, 2)
	if err == nil || call != nil {
		t.Error("Should not work witout return")
	}

	call, err = checkConditionFuncT(func(a, b int) (int, int, int) {
		return 0, 0, 0
	}, 2)
	if err == nil || call != nil {
	...
	call, err = checkConditionFuncT(func(a, b int) (int, int) {
		return 0, 0
	}, 2)
	if err == nil || call != nil {
